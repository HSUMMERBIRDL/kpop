package com.hl.foundation.library.widget.ireyclerview.widget;
...
import com.hl.foundation.library.widget.ireyclerview.RefreshTrigger;
...
//        setBackgroundColor(ResourcesUtils.getColor(R.color.colorTheme));
...
//                tvRefresh.setText("SWIPE TO REFRESH");  // 下拉刷新
                tvRefresh.setText("下拉刷新");  // 下拉刷新
            } else {
                tvRefresh.setText("释放刷新"); // 释放刷新
//                tvRefresh.setText("RELEASE TO REFRESH"); // 释放刷新
                if (!rotated) {
                    ivArrow.clearAnimation();
    ...
    public void onRefresh() {
        ...
        tvRefresh.setText("正在加载");  // 正在加载
//        tvRefresh.setText("REFRESHING");  // 正在加载
    }
...
//        ivSuccess.setVisibility(VISIBLE);
        ...
        ivArrow.setVisibility(GONE);
        progressBar.setVisibility(GONE);
        tvRefresh.setText("加载完成"); // 加载完成
//        tvRefresh.setText("COMPLETE"); // 加载完成
    }
