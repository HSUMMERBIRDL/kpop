...
//        if ((localNetworkInfo != null) && (localNetworkInfo.isAvailable()))
        if ((null != localNetworkInfo) && (localNetworkInfo.isAvailable()))
            return true;
        return false;
    }
    /**
    ...
    public static String getIPAddress() {
        NetworkInfo info = ((ConnectivityManager) BaseApplication.getAppContext().getSystemService(Context.CONNECTIVITY_SERVICE)).getActiveNetworkInfo();
