...
import com.kp.monitor.presenter.LowPowerListPresenter;
import com.kp.monitor.ui.adapter.LowPowerListAdapter;
...
public class LowPowerActivity extends BaseListActivity<LowPowerListModel, LowPowerListPresenter, LowPowerVO> implements LowPowerListView{
    ...
    public static void startAction(Context context, String exceptionId) {
        ...
        Intent intent = new Intent(context, LowPowerActivity.class);
    ...
    protected CommonRecycleViewAdapter getAdapter() {
        return new LowPowerListAdapter(mContext, R.layout.list_item_low_power);
    }

    @Override
    public void onLowPowerBaicInfoComplete(UnusalInfoVO unusalInfoVO) {
