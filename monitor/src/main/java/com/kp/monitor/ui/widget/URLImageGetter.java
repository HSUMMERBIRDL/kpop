...
public class URLImageGetter implements Html.ImageGetter {
    ...
    private static final String mFilePath = BaseApplication.getAppContext().getCacheDir()
            .getAbsolutePath();
    ...
    private Drawable getDrawableFromNet(final String source) {
        ...
        mSubscription = Api.getApiService().getNewsBodyHtmlPhoto(Api.getCacheControl(), source)
    ...
    private Drawable createPicPlaceholder() {
        ...
        drawable = new ColorDrawable(BaseApplication.getAppContext().getResources().getColor
                (color));
